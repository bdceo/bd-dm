...
-- 导出 dm_douban 的数据库结构
DROP DATABASE IF EXISTS `dm_douban`;
...
DROP TABLE IF EXISTS `dou_book_tag`;
...
DROP TABLE IF EXISTS `dou_buylink`;
...
DROP TABLE IF EXISTS `dou_fetch_queue`;
...
DROP TABLE IF EXISTS `dou_fetch_tag`;
...
DROP TABLE IF EXISTS `dou_review`;
...
-- 数据导出被取消选择。
-- 导出  表 dm_douban.www_fang 结构
DROP TABLE IF EXISTS `www_fang`;
CREATE TABLE IF NOT EXISTS `www_fang` (
  `id` bigint(20) NOT NULL,
  `infoFrom` tinyint(4) NOT NULL,
  `infoUrl` varchar(50) CHARACTER SET utf8mb4 NOT NULL DEFAULT '',
  `infoTitle` varchar(50) CHARACTER SET utf8mb4 NOT NULL DEFAULT '',
  `infoDetail` text CHARACTER SET utf8mb4 NOT NULL,
  `pTime` datetime DEFAULT NULL,
  `cTime` datetime NOT NULL,
  `mTime` datetime DEFAULT NULL,
  `infoStat` tinyint(4) NOT NULL,
  `infoTel` varchar(50) CHARACTER SET utf8mb4 NOT NULL DEFAULT '',
  `infoQQ` varchar(50) CHARACTER SET utf8mb4 NOT NULL DEFAULT '',
  `infoWX` varchar(50) CHARACTER SET utf8mb4 NOT NULL DEFAULT '',
  `infoEmail` varchar(50) CHARACTER SET utf8mb4 NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
  KEY `infoUrl` (`infoUrl`)
